...
class TourManage extends Component {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if (prevProps.toursA2 !== this.props.toursA2) {
      this.setState({
        tour: this.props.toursA2,
      });
    }

    if (prevProps.placesA2 !== this.props.placesA2) {
      this.setState({
        placeArr: this.buildInputSelect(this.props.placesA2),
      });
    }
  }
      ...
      <div className="container tour-container">
        <div className="tour-content">
          <div className="row tour-info">
            <div className="text-center mt-5 title-tours">Quản lý chuyến tham quan quốc tế</div>
